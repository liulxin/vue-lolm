      ...
      <el-tabs value="basic" type="border-card">
        <el-tab-pane label="基础信息" name="basic">
          ...
          <el-form-item label="头像">
            <el-upload class="avatar-uploader" :action="`${$http.defaults.baseURL}/upload`" :show-file-list="false" :headers="getAuthHeaders()" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
              <img v-if="model.avatar" :src="model.avatar" class="avatar" />
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item label="Banner">
            <el-upload class="avatar-uploader" :action="`${$http.defaults.baseURL}/upload`" :show-file-list="false" :headers="getAuthHeaders()" :on-success="handleBannerSuccess" :before-upload="beforeAvatarUpload">
          ...
          <el-form-item label="难度">
            <el-rate style="margin-top: 10px;" v-model.trim="model.scores.difficult" :max="10" :show-score="true"></el-rate>
          </el-form-item>
          <el-form-item label="物理">
            <el-rate style="margin-top: 10px;" v-model.trim="model.scores.attack" :max="10" :show-score="true"></el-rate>
          </el-form-item>
          <el-form-item label="魔法">
            <el-rate style="margin-top: 10px;" v-model.trim="model.scores.skills" :max="10" :show-score="true"></el-rate>
          </el-form-item>
          <el-form-item label="防御">
            <el-rate style="margin-top: 10px;" v-model.trim="model.scores.survive" :max="10" :show-score="true"></el-rate>
          </el-form-item>
          ...
          <el-row sype="flex" style="flex-wrap: wrap">
            <el-col :md="10" v-for="(item, i) in model.skills" :offset="1" :key="i" style="margin-top: 10px">
              ...
              <el-form-item label="图标">
                <el-upload class="avatar-uploader" :headers="getAuthHeaders()" :action="`${$http.defaults.baseURL}/upload`" :show-file-list="false" :on-success="res => $set(item, 'icon', res.url)" :before-upload="beforeAvatarUpload">
        ...
        <el-tab-pane label="皮肤" name="skins">
          ...
          <el-row sype="flex" style="flex-wrap: wrap">
            <el-col :md="10" v-for="(item, i) in model.skins" :offset="1" :key="i" style="margin-top: 10px">
              ...
              <el-form-item label="图标">
                <el-upload class="avatar-uploader skins" :headers="getAuthHeaders()" :action="`${$http.defaults.baseURL}/upload`" :show-file-list="false" :on-success="res => $set(item, 'pic', res.url)" :before-upload="beforeAvatarUpload">
